...
There are some notable limitations of current block-DDA_Py:
...
The author developed and tested current block-DDA_Py using Python 3.12.8 in Windows 11 machines.
