...
matching the convergence-figure slot of fig 1 / fig 4 for cross-figure
...
- The Au row uses a **relaxed residual gate**
  (`PHASE3_RESIDUAL_THRESHOLD = $10^{-3}$`, identical to fig 4's
  ...
  caption alongside fig 4's analogous gate.
