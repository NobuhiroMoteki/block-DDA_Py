...
\author{N.\ Moteki}
\date{Last updated: 2026-03-25 (corresponds to block-DDA\_Py v0.4.0)}
...
circular.
This setting is hard-coded in the current version (v0.4.0).
...
In the current version (v0.4.0), $\ell_c = 0.3\,c$ is adopted as an
empirical choice.
